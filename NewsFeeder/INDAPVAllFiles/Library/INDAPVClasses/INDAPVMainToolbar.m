...
-(void)SetFramesForOrientation
{
    ...
    else if([appDelObj.strOrientation isEqualToString:@"Portrait"]||[appDelObj.strOrientation isEqualToString:@"PortraitUpsideDown"])
    {
        ...
        {
            aFrameDone=CGRectMake(BUTTON_X_IPHONE, BUTTON_Y+appDelObj.intIOS7, BUTTON_WIDTH_HEIGHT_IPHONE, BUTTON_WIDTH_HEIGHT_IPHONE);
            aFrameSetting=CGRectMake(282, BUTTON_Y+appDelObj.intIOS7, BUTTON_WIDTH_HEIGHT_IPHONE, BUTTON_WIDTH_HEIGHT_IPHONE);
            aFrameMail=CGRectMake(282 - BUTTON_WIDTH_HEIGHT_IPHONE - 10, BUTTON_Y+appDelObj.intIOS7, BUTTON_WIDTH_HEIGHT_IPHONE, BUTTON_WIDTH_HEIGHT_IPHONE);
            ...
            aFrameMark=CGRectMake(282 - BUTTON_WIDTH_HEIGHT_IPHONE - 15 - BUTTON_WIDTH_HEIGHT_IPHONE, BUTTON_Y+appDelObj.intIOS7, MARK_BUTTON_HEIGHT_IPHONE, BUTTON_WIDTH_HEIGHT_IPHONE);
        }
    }
