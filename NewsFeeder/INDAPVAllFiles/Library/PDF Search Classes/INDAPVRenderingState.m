...
/********************************************************************************\
 *
 * File Name       INDAPVRenderingState.m
...
@implementation INDAPVRenderingState
...
{
	INDAPVRenderingState *copy = [[INDAPVRenderingState alloc] init];
...
- (id)init
{
	if ((self = [super init]))
	{
		...
		INDAPVRenderingState *rootRenderingState = [[INDAPVRenderingState alloc] init];
...
- (INDAPVRenderingState *)topRenderingState
{
...
{
	INDAPVRenderingState *state = [stack lastObject];
