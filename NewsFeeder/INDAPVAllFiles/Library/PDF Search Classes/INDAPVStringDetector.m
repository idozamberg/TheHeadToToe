...
/********************************************************************************\
 *
 * File Name       INDAPVStringDetector.m
...
@interface INDAPVStringDetector ()
- (void)didFindNeedle;
...
- (BOOL)append:(NSString *)string isLast:(BOOL *)isLast font:(INDAPVFont *)font
{
...
- (NSString *)stringByExpandingLigatures:(NSString *)string font:(INDAPVFont *)font
{
